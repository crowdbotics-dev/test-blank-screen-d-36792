...
## Project Structure
    ...
    ├── test_blank_screen_d_36792  # Django project configurations
...
1. Clone this repo and `cd test_blank_screen_d_36792`
...
2. Clone this repo and `cd test_blank_screen_d_36792`
